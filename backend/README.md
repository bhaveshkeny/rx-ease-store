...
The SQLite database (`pharmacy.db`) will be created automatically on first boot.
...
- On first boot the tables are created in `pharmacy.db` and seeded with 18 medicines.
